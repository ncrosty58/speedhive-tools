...
try:
    from speedhive.exporters import export_events, export_sessions, export_laps, export_announcements, export_results
except Exception:
...
try:
    from speedhive.generated.api.organization_controller.get_event_list import asyncio_detailed as get_events_for_org_async
except Exception:
    get_events_for_org_async = None

get_sessions_for_event_async: Optional[Callable[..., Awaitable[Any]]] = None
try:
    from speedhive.generated.api.event_controller.get_session_list import asyncio_detailed as get_sessions_for_event_async
except Exception:
    get_sessions_for_event_async = None

get_announcements_for_session_async: Optional[Callable[..., Awaitable[Any]]] = None
try:
    from speedhive.generated.api.session_controller.get_announcements import asyncio_detailed as get_announcements_for_session_async
except Exception:
...
try:
    from speedhive.generated.api.session_controller.get_classification import asyncio_detailed as get_classification_for_session_async
except Exception:
...
for candidate in (
    ...
    try:
        mod = __import__(f"speedhive.generated.api.session_controller.{candidate}", fromlist=["*"])
